...
function LoginPageContent() {
  ...
  return (
    <AuthPageWrapper title={shouldAutoLogin ? "Logging you in..." : "Login to your account"} skipRedirect={shouldAutoLogin}>
        {shouldAutoLogin ? (
          <AutoLoginForm token={token} email={email} action={action || undefined} />
        ) : (
          <LoginForm />
        )}
      </AuthPageWrapper>
